...
We then perform an inverse Fourier Transform on the signal and, given that the Shannon-Nyquist condition is met, we will have recovered the original signal. %check that this is true
