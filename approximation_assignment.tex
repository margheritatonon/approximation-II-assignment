...
Sampling the sine wave with a sampling frequency of 7 Hz, less than the Shannon-Nyquist threshold, is seen in Figure 3. 
Sampling the sine wave with a sampling frequency of 12 Hz, greater than the Shannon-Nyquist threshold, is seen in Figure 4.

%TODO: when the paper is done being written, need to fix the formatting of these images. also need to add code before you fix it.
...
As expected, the time domain representation of the signal sampled at 12 Hz has more spikes than the signal sampled at 7 Hz. 
